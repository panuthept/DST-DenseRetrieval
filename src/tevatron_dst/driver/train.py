...
from tevatron_dst.arguments import ModelArguments, DataArguments, \
    DenseTrainingArguments as TrainingArguments
from tevatron_dst.data import TrainDataset, TypoQPCollator, TypoCharacterQPCollator
from tevatron_dst.preprocessor import HFTrainPreProcessor
from tevatron_dst.modeling import DualSelfTeachingDenseModel
from tevatron_dst.trainer import DenseTypoTrainer as TypoTrainer
...
def main():
    ...
    model = DualSelfTeachingDenseModel.build(
        model_args,
        data_args,
        training_args,
        config=config,
